export const displayName = "Admin Operations Dashboard";
      ...
      <main className="main-content">
        ...
        <header className="topbar" id="topbar">
          ...
          <h1 className="topbar-title">
            {"Resumen de Operaciones Administrativas"}
          </h1>
          {"\n      \n      "}
        ...
        <div className="dashboard-scroll-area">
          ...
          <section className="stats-grid">
            ...
            <div className="kpi-card kpi-total">
              ...
              <div className="kpi-header">
                {"\n            "}
                <span className="kpi-title">{"Total Pedidos Activos"}</span>
                {"\n            "}
              ...
              <div className="kpi-footer">
                ...
                {"\n            "}
                <span className="kpi-context">{"vs Ãºltima hora"}</span>
                {"\n          "}
              </div>
              {"\n        "}
            </div>
            ...
            <div className="kpi-card kpi-pending">
              ...
              <div className="kpi-header">
                {"\n            "}
                <span className="kpi-title">{"Pendientes (Cocina/Bar)"}</span>
                {"\n            "}
            ...
            <div className="kpi-card kpi-preparing">
              ...
              <div className="kpi-content">
                {"\n            "}
                <span className="kpi-value">{"11"}</span>
                {"\n          "}
              </div>
              {"\n          "}
              <div className="kpi-footer">
          ...
          <section>
            ...
            <div className="kanban-section-title">
              {"\n          "}
              <span>{"Cola de Pedidos en Vivo"}</span>
              {"\n          "}
              <button
            ...
            <div className="kanban-board">
                ...
                <div className="order-card" data-media-type="banani-button">
                  ...
                  <div className="order-header">
                    ...
                    <div className="table-info">
                      ...
                      {"\n                  "}
                      <span className="order-id">{"#ORD-8924"}</span>
                      {"\n                "}
                    </div>
                    {"\n                "}
                  ...
                  <div className="order-items">
                    ...
                    <div className="order-item">
                      ...
                      <div className="item-name">
                        ...
                        <span className="item-note">{"Salsa aparte"}</span>
                        {"\n                  "}
                      </div>
                      {"\n                "}
                    </div>
                    ...
                    <div className="order-item">
                      ...
                      <span className="item-qty">{"1x"}</span>
                      {"\n                  "}
                      <div className="item-name">{"Ensalada CÃ©sar"}</div>
                      {"\n                "}
                    </div>
                    {"\n              "}
                  </div>
              ...
              <div className="kanban-column preparing">
                ...
                <div className="kanban-header">
                  ...
                  {"\n              "}
                  <span className="kanban-count">{"11"}</span>
                  {"\n            "}
                </div>
                {"\n            \n            "}
                {}
                ...
                <div className="order-card" data-media-type="banani-button">
                  ...
                  <div className="order-header">
                    ...
                    <div className="table-info">
                      {"\n                  "}
                      <span className="table-number">{"Bar 02"}</span>
                      {"\n                  "}
                      <span className="order-id">{"#ORD-8919"}</span>
                      {"\n                "}
                    </div>
                    {"\n                "}
                    <div className="time-badge normal">
                  ...
                  <div className="order-items">
                    ...
                    <div className="order-item">
                      ...
                      <span className="item-qty">{"1x"}</span>
                      {"\n                  "}
                      <div className="item-name">{"Margarita Picante"}</div>
                      {"\n                "}
                    </div>
                    {"\n                "}
                    <div className="order-item">
                      ...
                      <span className="item-qty">{"1x"}</span>
                      {"\n                  "}
                      <div className="item-name">{"Nachos para Compartir"}</div>
                      {"\n                "}
                    </div>
                    {"\n              "}
                  </div>
                ...
                <div className="order-card" data-media-type="banani-button">
                  ...
                  <div className="order-header">
                    ...
                    <div className="table-info">
                      ...
                      {"\n                  "}
                      <span className="order-id">{"#ORD-8912"}</span>
                      {"\n                "}
                    </div>
                    {"\n                "}
                    <div className="time-badge normal">
                  ...
                  <div className="order-items">
                    ...
                    <div className="order-item">
                      ...
                      <span className="item-qty">{"1x"}</span>
                      {"\n                  "}
                      <div className="item-name">{"Matcha Latte FrÃ­o"}</div>
                      {"\n                "}
                    </div>
                    {"\n              "}
                  </div>
